...
<title>Ricerca Per Preventivo</title>
<style>
.p {
	text-align: center;
	margin: auto;
...
<body>
	<s:form action="RicercaPreventivoFatturaAction">
		...
		<P align="center">
			<FONT size="+2" color="ff0000#">Ricerca&nbsp;Per&nbsp;Preventivo</FONT><BR>
		</P>
			<table class="p">
			<tr>
				<s:select label="Preventivo" name="chiavePreventivo" list="#session.listaPreventivi" value="%{#session.oggettoFatturaPassiva.opreventivo.chiave}" />	
			</tr>
			<tr>
