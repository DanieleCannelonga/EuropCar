...
public class GestioneDefinizione extends ActionSupport implements SessionAware {
	...
	public static final String KEY_LISTAAREE2 = "listaAree2";
	...
	public String cerca() {
		sessionMap.put(KEY_LISTAAREE2, oAreaService.elencoAreePerSottoCategoria(Integer.parseInt(this.chiaveArea.replace("\'", ""))));
		return "RicercaDefinizione";
	}

	public String modificaDefinizione() {
		sessionMap.put(KEY_OBJ, oSottoCategoriaService.findById(Integer.parseInt(this.chiave.replace("\'", ""))));
		return "modificaDefinizione";
	}
