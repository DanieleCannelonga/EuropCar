...
public class RicercaPerSottoCategoria extends ActionSupport implements SessionAware {
	...
	public String cerca() {
		...
		sessionMap.put(KEY_LISTASOTTOCATEGORIE, mapSottoCategoria);
		sessionMap.put(KEY_LISTAFATTUREPASSIVE, (oFatturaPassivaService.elencoFatturePassiveTramiteDettaglioPerSottoCategoria(Integer.parseInt(this.chiaveSottoCategoria.replace("\'", "")))));
